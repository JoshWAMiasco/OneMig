...
namespace PROJECT
{
    class Connection
    {
        public static MySqlConnection connect = new MySqlConnection("server=CAV-DT-TSG15B;user id=root;password=onemigso101996;database=boards_for_verification");
        public static MySqlConnection ConnectBoards = new MySqlConnection("server=CAV-DT-TSG15B;user id=root;password=onemigso101996;database=boards_of_testers");
